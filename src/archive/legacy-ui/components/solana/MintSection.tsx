...
import { useCandyMachineState } from "../../../../components/solana/useCandyMachineState";
import { useMintNft } from "../../../../components/solana/useMintNft";
import { MINT_PRICE_DISPLAY } from "../../../../lib/solana/constants";

export function LegacyMintSection() {
    ...
    <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-6 py-20">
      ...
      >
        ...
        <div>
          ...
          <p className="text-chrome-dim/60 text-sm">Metaplex Core • 777 supply</p>
        </div>
